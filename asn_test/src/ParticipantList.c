...
static asn_per_constraints_t asn_PER_type_ParticipantList_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  16 }	/* (SIZE(1..16)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ParticipantList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_ParticipantList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ParticipantList = {
	...
	sizeof(asn_DEF_ParticipantList_tags_1)
		/sizeof(asn_DEF_ParticipantList_tags_1[0]), /* 1 */
	&asn_PER_type_ParticipantList_constr_1,
