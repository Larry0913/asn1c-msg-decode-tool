 ...
 */
static void
VehicleEventFlags_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
VehicleEventFlags_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	VehicleEventFlags_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
VehicleEventFlags_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
VehicleEventFlags_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleEventFlags_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
VehicleEventFlags_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleEventFlags_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
VehicleEventFlags_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
VehicleEventFlags_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_VehicleEventFlags_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_VehicleEventFlags = {
	"VehicleEventFlags",
	"VehicleEventFlags",
	VehicleEventFlags_free,
	VehicleEventFlags_print,
	VehicleEventFlags_constraint,
	VehicleEventFlags_decode_ber,
	VehicleEventFlags_encode_der,
	VehicleEventFlags_decode_xer,
	VehicleEventFlags_encode_xer,
	VehicleEventFlags_decode_uper,
