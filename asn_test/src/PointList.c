...
static asn_per_constraints_t asn_PER_type_PointList_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  2,  31 }	/* (SIZE(2..31)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_PointList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_PointList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PointList = {
	...
	sizeof(asn_DEF_PointList_tags_1)
		/sizeof(asn_DEF_PointList_tags_1[0]), /* 1 */
	&asn_PER_type_PointList_constr_1,
	asn_MBR_PointList_1,
	1,	/* Single element */
