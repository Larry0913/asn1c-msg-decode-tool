...
asn_dec_rval_t
SirenInUse_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SirenInUse_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_SirenInUse_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_SirenInUse_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_SirenInUse = {
	...
	SirenInUse_decode_uper,
	SirenInUse_encode_uper,
