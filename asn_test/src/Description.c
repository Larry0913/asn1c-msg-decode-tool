...
static int
memb_textString_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_textGB2312_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static asn_per_constraints_t asn_PER_memb_textString_constr_2 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  0,  127 }	/* (0..127) */,
	{ APC_CONSTRAINED,	 9,  9,  1,  512 }	/* (SIZE(1..512)) */,
	0, 0	/* No PER character map necessary */
};
static asn_per_constraints_t asn_PER_memb_textGB2312_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 9,  9,  2,  512 }	/* (SIZE(2..512)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_Description_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_Description_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Description, choice.textString),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_IA5String,
		memb_textString_constraint_1,
		&asn_PER_memb_textString_constr_2,
		0,
		"textString"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct Description, choice.textGB2312),
		...
		memb_textGB2312_constraint_1,
		&asn_PER_memb_textGB2312_constr_3,
		0,
		"textGB2312"
		},
};
...
static asn_CHOICE_specifics_t asn_SPC_Description_specs_1 = {
