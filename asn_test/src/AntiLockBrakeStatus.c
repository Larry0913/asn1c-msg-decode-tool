...
asn_dec_rval_t
AntiLockBrakeStatus_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AntiLockBrakeStatus_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_AntiLockBrakeStatus_constr_1 GCC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_AntiLockBrakeStatus_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_AntiLockBrakeStatus = {
	...
	AntiLockBrakeStatus_decode_uper,
	AntiLockBrakeStatus_encode_uper,
