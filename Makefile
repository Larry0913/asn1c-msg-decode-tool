...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/config/missing AUTHORS ChangeLog TODO config.sub \
...
CFLAGS = -g -O2 -Wall -Wcast-qual -Wchar-subscripts -Wmissing-prototypes -Wmissing-declarations -Wno-error=cast-align
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
SET_MAKE = 
SHELL = /bin/bash
SKELETONS_CFLAGS =   -std=c89 -Wpedantic -Wno-duplicate-decl-specifier
STRIP = strip
TESTSUITE_CFLAGS =  -std=gnu99 -Wno-error=unused-variable
VERSION = 0.9.28
YACC = yacc
YFLAGS = 
abs_builddir = /mnt/hgfs/git_local/asn1c-0.9.28
abs_srcdir = /mnt/hgfs/git_local/asn1c-0.9.28
abs_top_builddir = /mnt/hgfs/git_local/asn1c-0.9.28
abs_top_srcdir = /mnt/hgfs/git_local/asn1c-0.9.28
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /mnt/hgfs/git_local/asn1c-0.9.28/config/install-sh
